...
$consulta = "SELECT id, materia, descripcion FROM materias";
...
<div class="container">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevoMateria" type="button" class="btn btn-success" data-toggle="modal">Nuevo</button>    
            </div>    
        </div>    
    </div>    
    <br>  
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="tablaMateria" class="table table-striped table-bordered table-condensed" style="width:100%">
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formMateria">    
            <div class="modal-body">
                ...
                <input type="number" class="form-control" id="idMateria" hidden>
